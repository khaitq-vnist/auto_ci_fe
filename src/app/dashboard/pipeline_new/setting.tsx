...
const Settings: React.FC<SettingsProps> = ({ settings, onUpdateSettings }) => {
    ...
    const fetchBranches = async (): Promise<void> => {
        try {
            ...
            const id = searchPrams.get('id'); // Get project ID from the query parameters
            ...
            const response = await projectService.fetchListBranches(id); // Replace with real API call
